...
template<int func(const char *, u32, const char *, u32, u32)> void WrapI_CUCUU() {
	int retval = func(Memory::GetCharPointer(PARAM(0)), PARAM(1), Memory::GetCharPointer(PARAM(2)), PARAM(3), PARAM(4));
	RETURN(retval);
}
